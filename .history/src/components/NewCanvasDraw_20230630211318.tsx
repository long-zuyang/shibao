...
interface CanvasDrawProps {
  /** 图片路径 */
  src: string;
  saveImg: (event: React.MouseEvent<HTMLButtonElement>) => void;
}
...
class CanvasDraw extends React.Component<CanvasDrawProps> {
  ...
  render() {
    this.props.saveImg(thhis.handleSaveImg as onButtonClick as (event: React.MouseEvent<HTMLButtonElement>) => void);
