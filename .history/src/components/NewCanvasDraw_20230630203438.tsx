...
class CanvasDraw extends React.Component<CanvasDrawProps> {
  ...
  componentDidMount(): void {
    ...
    // 渲染表情图
    this.drawMeme(canvas, ctx, this.props.src);
  ...
  componentDidUpdate(): void {
    ...
    // console.log('Update');
    this.drawMeme(this.state.canvas, this.state.ctx, this.props.src);
  }
   ...
   * @param nickName 昵称
   */
   drawNickName(context: CanvasRenderingContext2D, nickName: string) {
    if (!context) {
      return 0;
    }
